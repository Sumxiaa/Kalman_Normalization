...
def main():
    parser = argparse.ArgumentParser(description='CIFAR-10 Training with Kalman Normalization')
    parser.add_argument('--norm_type', type=str, default='kn', choices=['kn', 'gkn', 'gn'])
    parser.add_argument('--split_num', type=int, default=4)
    parser.add_argument('--num_groups', type=int, default=4)
    parser.add_argument('--p_rate', type=float, default=0.9)
